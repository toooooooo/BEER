...
namespace TDTK {
	...
	public class UnitEditorWindow : EditorWindow {
      ...
      if ((tower && tower.type == _TowerType.Electric))
      {
        ...
        cont = new GUIContent("Elec. Regeneration:", "The electricity generated by this tower or received by a drone.");
        EditorGUI.LabelField(new Rect(startX, startY += spaceY, width, height), cont);
        ...
        cont = new GUIContent("Current electricity stored:", "The electricity currently available at this tower.");
        EditorGUI.LabelField(new Rect(startX, startY += spaceY, width, height), cont);
        tower.currentElectricity = EditorGUI.FloatField(new Rect(startX + spaceX, startY, fWidth, height), tower.currentElectricity);
      }
